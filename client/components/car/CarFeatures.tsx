...
import { BatteryFull, CalendarDays, CarFront, Cog, DoorClosed, Fuel, Milestone, RockingChair } from 'lucide-react';
...
const CarFeatures = ({ car }: ICarFeaturesProps) => {
  const features = [
    { name: car?.brand, icon: CarFront },
    { name: car?.category, icon: CarFront },
    ...
    { name: `${car?.mileage} KM`, icon: Milestone },
